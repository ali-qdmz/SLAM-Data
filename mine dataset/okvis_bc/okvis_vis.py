...
def calc_data():
    ...
    if len(df_ground_truth) > len(df_localization):
        ...
        l = []
        data = []
        gt_0 = df_ground_truth["rosbagTimestamp"][0]
        odom_0 = df_localization['rosbagTimestamp'][0]
        offset = abs(odom_0 - gt_0)
        df_localization['rosbagTimestamp'] = df_localization['rosbagTimestamp'] - offset
