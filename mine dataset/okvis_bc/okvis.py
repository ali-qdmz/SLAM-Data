...
df_odom = pd.read_csv(dir + "/okvis_odometry/_slash_okvis_node_slash_okvis_odometry.csv")
df_gt = pd.read_csv(dir + "/okvis_odometry/_slash_dwm1001_slash_tag_slash_tag_slash_position.csv")
...
odom_object.scale_shift_rotate(scale=1.5, shift_x=shift_x,shift_y=shift_y,rotate= -15)
