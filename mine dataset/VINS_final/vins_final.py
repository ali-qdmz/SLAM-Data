...
df_odom = pd.read_csv(dir + "/VINS_final/_slash_vins_estimator_slash_odometry.csv")
df_gt = pd.read_csv(dir + "/VINS_final/_slash_dwm1001_slash_tag_slash_tag_slash_position.csv")

# df_odom = df_odom.drop(df_odom.index[range(80)])
# df_odom.index = range(len(df_odom))
...
odom_object.scale_shift_rotate(scale=1, shift_x=shift_x,shift_y=shift_y,rotate=-3)
