...
df_odom = pd.read_csv("/home/ali/bagfiles (copy)/visio_13/_slash_mono_odometer_slash_pose.csv")
...
def main():
    mse, x_odom, y_odom, x_gt, y_gt = minimum_rmse_angle(40, scale=5.5, df_odom=df_odom, df_gt=df_gt)
    curve1 = []
    for i in range(len(x_odom)):
