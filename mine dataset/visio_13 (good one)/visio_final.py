...
df_odom = pd.read_csv(dir + "/visio_13 (good one)/_slash_mono_odometer_slash_odometry.csv")
df_gt = pd.read_csv(dir + "/LIO_final/_slash_lio_sam_slash_mapping_slash_odometry.csv")
...
odom_object.scale_shift_rotate(scale=1, shift_x=shift_x,shift_y=shift_y,rotate=-120)
