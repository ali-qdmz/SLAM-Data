...
df_mem_1 = pd.read_csv(directory_myself + '/_slash_cpu_monitor_slash_featureAssociation_slash_mem.csv')
df_mem_2 = pd.read_csv(directory_myself + '/_slash_cpu_monitor_slash_imageProjection_slash_mem.csv')
df_mem_3 = pd.read_csv(directory_myself + '/_slash_cpu_monitor_slash_mapOptmization_slash_mem.csv')
