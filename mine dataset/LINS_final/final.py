...
shift_x = ground_truth_object.x[150] - odom_object.x[0]
shift_y = ground_truth_object.y[150] - odom_object.x[0]

odom_object.scale_shift_rotate(scale=1, shift_x=shift_x,shift_y=shift_y,rotate=-92)
