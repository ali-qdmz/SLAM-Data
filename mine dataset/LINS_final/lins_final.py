...
df_odom = pd.read_csv(dir + "/LINS_final/_slash_laser_odom_to_init.csv")
df_gt = pd.read_csv(dir + "/LINS_final/_slash_dwm1001_slash_tag_slash_tag_slash_position.csv")
...
odom_object.scale_shift_rotate(scale=1, shift_x=shift_x,shift_y=shift_y,rotate=-94)
