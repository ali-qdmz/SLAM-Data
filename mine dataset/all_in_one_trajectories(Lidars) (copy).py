...
# odom_object.scale_shift_rotate(scale=1, shift_x=shift_x,shift_y=shift_y,rotate=-2)
# plot_all_in_one(odom_obj=odom_object,gt_obj=gt_obj, color='black')
...
# plot_all_in_one(odom_obj=odom_object,gt_obj=gt_obj, color='grey', label="LIO")
...
# shift_y = gt_obj.y[0] - odom_object.y[0]
# odom_object.scale_shift_rotate(scale=1, shift_x=shift_x,shift_y=shift_y,rotate=rotation + -5)
# plot_all_in_one(odom_obj=odom_object,gt_obj=gt_obj, color='cyan', label="A-LOAM")
...
# shift_y = gt_obj.y[0] - odom_object.y[0]
# odom_object.scale_shift_rotate(scale=1, shift_x=shift_x,shift_y=shift_y,rotate=rotation + -5)
# plot_all_in_one(odom_obj=odom_object,gt_obj=gt_obj, color='olive', label="FAST LIO")
...
# shift_y = gt_obj.y[0] - odom_object.y[0]
# odom_object.scale_shift_rotate(scale=1, shift_x=shift_x,shift_y=shift_y,rotate=rotation + -5)
# plot_all_in_one(odom_obj=odom_object,gt_obj=gt_obj, color='orange', label="FAST LIO SC")
...
# shift_y = gt_obj.y[0] - odom_object.y[0]
# odom_object.scale_shift_rotate(scale=1, shift_x=shift_x,shift_y=shift_y,rotate=rotation + -5)
# plot_all_in_one(odom_obj=odom_object,gt_obj=gt_obj, color='red', label="Trajectory")
...
# shift_y = gt_obj.y[0] - odom_object.y[0]
# odom_object.scale_shift_rotate(scale=1, shift_x=shift_x,shift_y=shift_y,rotate=rotation + -5)
# plot_all_in_one(odom_obj=odom_object,gt_obj=gt_obj, color='green', label="ISCLOAM")
...
# plot_all_in_one(odom_obj=odom_object,gt_obj=gt_obj, color='purple', label="LEGO LOAM")
...
# plot_all_in_one(odom_obj=odom_object,gt_obj=gt_obj, color='brown', label="LINS")
...
shift_y = gt_obj.y[0] - odom_object.y[0]
odom_object.scale_shift_rotate(scale=1, shift_x=shift_x,shift_y=shift_y,rotate=rotation + -5)
plot_all_in_one(odom_obj=odom_object,gt_obj=gt_obj, color='blue', label="Ground truth")
...
# shift_y = gt_obj.y[0] - odom_object.y[0]
# odom_object.scale_shift_rotate(scale=1, shift_x=shift_x,shift_y=shift_y,rotate=rotation + 85)
# plot_all_in_one(odom_obj=odom_object,gt_obj=gt_obj, color='yellow', label="LEGO LOAM SC")
...
plt.xlabel('x, [meters]', fontsize='large')
plt.ylabel('y, [meters]', fontsize='large')
fig.savefig("all_trajectories.png", format='png', dpi=600)
