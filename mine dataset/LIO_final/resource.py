...
df_mem_1 = pd.read_csv(directory_myself + '/_slash_cpu_monitor_slash_lio_sam_imageProjection_slash_mem.csv')
df_mem_2 = pd.read_csv(directory_myself + '/_slash_cpu_monitor_slash_lio_sam_imuPreintegration_slash_mem.csv')
df_mem_3 = pd.read_csv(directory_myself + '/_slash_cpu_monitor_slash_lio_sam_mapOptmization_slash_mem.csv')
