...
df_odom = pd.read_csv(dir + "/FAST_LIO_SLAM(SC)_final/_slash_Odometry.csv")
df_gt = pd.read_csv(dir + "/FAST_LIO_SLAM(SC)_final/_slash_dwm1001_slash_tag_slash_tag_slash_position.csv")
