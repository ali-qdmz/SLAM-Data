...
ax = df_cpu_total.plot(label='A LOAM')
...
df_cpu_total = df_cpu_total.iloc[0:len(df_cpu_total):1]
ax = df_cpu_total.plot(label='FAST LIO')
ax.set_xlim(0, len(df_cpu_total))
...
df_cpu_total = df_cpu_total.iloc[0:len(df_cpu_total):1]
ax = df_cpu_total.plot(label='FAST LIO SC')
ax.set_xlim(0, len(df_cpu_total))
...
df_cpu_total = df_cpu_total.iloc[0:len(df_cpu_total):1]
ax = df_cpu_total.plot(label='F LOAM')
ax.set_xlim(0, len(df_cpu_total))
...
df_cpu_total = df_cpu_1['data']/3 + df_cpu_2['data']/3 + df_cpu_3['data']/3
df_cpu_total = df_cpu_total.iloc[0:len(df_cpu_total):1]
ax = df_cpu_total.plot(label='LEGO LOAM')
ax.set_xlim(0, len(df_cpu_total))
...
ax = df_cpu_total.plot(label='LIO')
ax.set_xlim(0, len(df_cpu_total))
...
ax = df_cpu_total.plot(label='LVI')
ax.set_xlim(0, len(df_cpu_total))
