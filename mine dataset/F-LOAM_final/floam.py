...
dir = "/media/ali/7d1ffac0-df0c-41be-94fa-8e6867e442a3/home/ali/bagfiles (copy)"


df_odom = pd.read_csv(dir + "/floam_final/_slash_odom.csv")
df_gt = pd.read_csv(dir + "/FAST_LIO_final/_slash_dwm1001_slash_tag_slash_tag_slash_position.csv")
